...
import 'package:visions_academy/organic1/videoUp2.dart';
import 'package:visions_academy/videos_gallery/sliver_app_bar.dart';
import 'package:visions_academy/videos_gallery/sliver_persistent_header_delegate.dart';

class ScreenVideo1 extends StatefulWidget {
  ScreenVideo1({Key key, this.courseName, this.chaptNo}) : super(key: key);
...
class _ScreenVideo1State extends State<ScreenVideo1>
  ...
  void initState() {
    ...
    _pages = [
      ...
      Tuple3('Tutorials', ChapterOneOrganic(), Icon(Icons.image)),
    ];
